...
dataset_conf = pd.read_csv(r"G:\Semester - 3\Project\Datasets\raw\meta\Confidence.csv")

clean_dataset = dataset_conf.fillna(value = 0)

correlations_conf_answers = []

correlations_conf_answers.append(scipy.stats.pearsonr(clean_dataset['Confidences'], clean_dataset['Answers']))

print "Correlation & P-Value between confidence and scores"
print correlations_conf_answers
